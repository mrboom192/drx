    ...
    <PageScrollView>
      ...
      >
        ...
        <TextRegular style={{ marginBottom: 12 }}>
          Welcome to DRX GENIUS LLC (“Company”, “we”, “us”, or “our”). These
          Terms of Service (“Terms”) govern your use of our mobile telehealth
          app and related services (collectively, the “Service”). By accessing
        ...
        <TextRegular style={{ marginBottom: 12 }}>
          ...
          medical diagnosis or treatment. In case of emergency, call 911 or go
        ...
        <TextRegular style={{ marginBottom: 12 }}>
          ...
          Service in accordance with all applicable laws. You are responsible
        ...
        <TextRegular style={{ marginBottom: 12 }}>
          All content and materials provided through the Service are owned by
          DRX GENIUS LLC or its licensors and are protected by intellectual
          property laws.
        </TextRegular>
        ...
        <TextRegular style={{ marginBottom: 12 }}>
          ...
          Service at our discretion, without notice, if you violate these Terms
        ...
        <TextRegular style={{ marginBottom: 12 }}>
          ...
          fullest extent permitted by law, DRX GENIUS LLC disclaims all
