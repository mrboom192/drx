...
export default function PrivacyPolicyScreen() {
  ...
  return (
    ...
    >
      ...
      <TextSemiBold style={{ fontSize: 18, marginTop: 16, marginBottom: 6 }}>
        Interpretation
      </TextSemiBold>
      ...
      {[
        ...
        [
          "Application",
          "refers to DrX, the software program provided by the Company.",
        ],
        [
          "Company",
        ...
        <View key={index} style={{ marginBottom: 10 }}>
          <TextSemiBold>{term}</TextSemiBold>
          <TextRegular>{desc}</TextRegular>
        </View>
      ))}

      <TextSemiBold style={{ fontSize: 20, marginTop: 24 }}>
        Collecting and Using Your Personal Data
      </TextSemiBold>

      <TextSemiBold style={{ fontSize: 16, marginTop: 16 }}>
        Types of Data Collected
      </TextSemiBold>

      <TextSemiBold style={{ fontSize: 14, marginTop: 16 }}>
        Personal Data
      </TextSemiBold>
      ...
      <View style={{ marginTop: 8, paddingLeft: 16 }}>
        <TextRegular>• Email address</TextRegular>
        <TextRegular>• First name and last name</TextRegular>
        <TextRegular>• Phone number</TextRegular>
        <TextRegular>• Usage Data</TextRegular>
      </View>
      ...
      <View style={{ marginTop: 8, paddingLeft: 16 }}>
        <TextRegular>
          • <TextSemiBold>To provide and maintain our Service:</TextSemiBold>{" "}
          including to monitor the usage of our Service.
        </TextRegular>

        <TextRegular style={{ marginTop: 8 }}>
          • <TextSemiBold>To manage Your Account:</TextSemiBold> to manage Your
        ...
        <TextRegular style={{ marginTop: 8 }}>
          • <TextSemiBold>For the performance of a contract:</TextSemiBold> the
        ...
        <TextRegular style={{ marginTop: 8 }}>
          • <TextSemiBold>To provide You</TextSemiBold> with news, special
        ...
        <TextRegular style={{ marginTop: 8 }}>
          • <TextSemiBold>To manage Your requests:</TextSemiBold> To attend and
          manage Your requests to Us.
        </TextRegular>

        <TextRegular style={{ marginTop: 8 }}>
          • <TextSemiBold>For business transfers:</TextSemiBold> We may use Your
        ...
        <TextRegular style={{ marginTop: 8 }}>
          • <TextSemiBold>For other purposes:</TextSemiBold> We may use Your
      ...
      <TextRegular style={{ marginTop: 16 }}>
        We may share Your personal information in the following situations:
      </TextRegular>

      <View style={{ marginTop: 8, paddingLeft: 16 }}>
        <TextRegular>
          • <TextSemiBold>With Service Providers:</TextSemiBold> We may share
          Your personal information with Service Providers to monitor and
          analyze the use of our Service, to contact You.
        </TextRegular>

        <TextRegular style={{ marginTop: 8 }}>
          • <TextSemiBold>For business transfers:</TextSemiBold> We may share or
        ...
        <TextRegular style={{ marginTop: 8 }}>
          • <TextSemiBold>With Affiliates:</TextSemiBold> We may share Your
        ...
        <TextRegular style={{ marginTop: 8 }}>
          • <TextSemiBold>With business partners:</TextSemiBold> We may share
          Your information with Our business partners to offer You certain
          products, services or promotions.
        </TextRegular>

        <TextRegular style={{ marginTop: 8 }}>
          • <TextSemiBold>With other users:</TextSemiBold> when You share
        ...
        <TextRegular style={{ marginTop: 8 }}>
          • <TextSemiBold>With Your consent:</TextSemiBold> We may disclose Your
      ...
      <View style={{ marginTop: 8, paddingLeft: 16 }}>
        <TextRegular>• Comply with a legal obligation</TextRegular>
        <TextRegular>
        ...
        <TextRegular>• Protect against legal liability</TextRegular>
      </View>
      ...
      <View style={{ marginTop: 8, paddingLeft: 16 }}>
        <TextRegular>• By email: support@dr-x.com</TextRegular>
      </View>
    </PageScrollView>
  );
}
